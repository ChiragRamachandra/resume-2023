...
export default function HuePairPrivacyPolicy() {
	return (
		<Layout>
			<div className='container mx-auto px-4 py-8 max-w-4xl text-left'>
				<h1 className='text-3xl font-bold mb-6'>Privacy Policy for Hue Pair</h1>
				...
				<ul className='list-disc pl-6 mb-6 space-y-2'>
					...
					<li>
						<strong>Application</strong> refers to Hue Pair, the software
						program provided by the Company.
					</li>
					<li>
						<strong>Company</strong> (referred to as either &quot;the
						Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in
						this Agreement) refers to Hue Pair.
					</li>
					<li>
				...
				<h4 className='text-lg font-semibold mb-3'>Business Transactions</h4>
				<p className='mb-4'>
				...
				<h4 className='text-lg font-semibold mb-3'>Law enforcement</h4>
				<p className='mb-4'>
				...
				<h4 className='text-lg font-semibold mb-3'>Other legal requirements</h4>
				<p className='mb-2'>
				...
				<ul className='list-disc pl-6 mb-6'>
					<li>By email: chirag.ramachandra@gmail.com</li>
				</ul>
			</div>
			<Footer />
		</Layout>
